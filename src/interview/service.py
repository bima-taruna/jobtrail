...
class JobInterviewService:
    async def get_all_interviews_by_app_id(self, job_application_id, session: AsyncSession):
    ...
    async def get_interviews_by_id(self, job_application_id:str,job_interview_id:str,session:AsyncSession):
    ...
    async def create_job_interview(self, interview_data:JobInterviewCreateModel, job_application_id:uuid.UUID, session:AsyncSession):
    ...
    async def update_job_interview(self, job_application_id:str, job_interview_id:str,update_data:JobInterviewUpdateModel,session: AsyncSession):
        job_interview_to_update = await self.get_interviews_by_id(job_application_id,job_interview_id,session)
    ...
    async def delete_job_interview(self, job_application_id:str, job_interview_id, session:AsyncSession):
        job_interview_to_delete = await self.get_interviews_by_id(job_application_id, job_interview_id,session)
