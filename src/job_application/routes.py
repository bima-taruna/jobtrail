...
from src.job_application.schemas import JobApplicationUpdateModel, JobApplicationCreateModel, JobApplicationDetail
from fastapi.exceptions import HTTPException
from src.db.main import get_session
from src.db.models import JobApplication, User
...
async def create_job_application(job_data:JobApplicationCreateModel, session:AsyncSession = Depends(get_session), current_user: User = Depends(get_current_user)) :
...
async def update_job_application(id : str,job_data:JobApplicationUpdateModel,session:AsyncSession = Depends(get_session), current_user: User = Depends(get_current_user)) :
...
async def delete_job_application(id:str,session:AsyncSession = Depends(get_session), current_user: User = Depends(get_current_user)) :
